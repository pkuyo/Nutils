...
{
    static public class PlayerBaseHook
    {
        static public readonly PlayerFeature<float> slideSpeed = PlayerFloat("Nutils/slide_speed");
        static public readonly PlayerFeature<float> rollSpeed = PlayerFloat("Nutils/roll_speed");
        static public readonly PlayerFeature<float> jumpBoost = PlayerFloat("Nutils/jump_boost");
        static public readonly PlayerFeature<float> poleJump = PlayerFloat("Nutils/pole_jump");
        static public readonly PlayerFeature<float> wallJump = PlayerFloat("Nutils/wall_jump");
        static public readonly PlayerFeature<float> slideJumpCD = PlayerFloat("Nutils/slide_jump_cd");
        ...
        static private void Player_UpdateAnimationIL(ILContext il)
        {
                ...
                i => i.MatchStloc(26)))
            {
                ...
                c.EmitDelegate<Func<Player, int>>((self) =>
                {
                    ...
                    if (BaseAbilityData.TryGetValue(self, out ability) && ability.slideJumpCD >= 0)
        ...
        static private void Player_WallJump(On.Player.orig_WallJump orig, Player self, int direction)
        {
            PlayerBaseAbility ability = null;
        ...
        static private void Player_UpdateAnimation(On.Player.orig_UpdateAnimation orig, Player self)
        {
            PlayerBaseAbility ability = null;
            if (BaseAbilityData.TryGetValue(self, out ability))
            {
        ...
        static private void Player_ctor(On.Player.orig_ctor orig, Player self, AbstractCreature abstractCreature, World world)
        {
        ...
        static private void Player_Jump(On.Player.orig_Jump orig, Player self)
        {
        ...
        static public ConditionalWeakTable<Player, PlayerBaseAbility> BaseAbilityData;

    }

    public class PlayerBaseAbility
    {
